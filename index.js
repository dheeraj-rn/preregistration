...
var electivesSchema = require('./models/electives.model');
var registeredSchema = require('./models/register.model');
var loginSchema = require('./models/login.model');
var restrictionsSchema = require('./models/restrictions.model');
